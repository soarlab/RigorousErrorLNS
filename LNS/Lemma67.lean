...
lemma monoWm1 (hd : Δ > 0) (hc : c < 0) (h1 : r ≥ ΔP) (htp: t ≤ ΔP) :
...
lemma mainlem67 (hd : Δ > 0) (hc : c < 0) (ht0 : 0 ≤ t) (htp : t ≤ ΔP) (htr : t ≤ r)
...
lemma Wm_eq_Qm (hc : c < 0) (hΔ : Δ > 0) : Qm Δ c r - Qm Δ c rr = Wm c Δ r (r - rr) := by
